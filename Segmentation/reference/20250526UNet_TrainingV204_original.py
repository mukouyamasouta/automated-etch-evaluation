...
#学習データの読み込み
train_file = "../../Dataset/20250515 CSV_Data/Segmentation/Detected_padded/train.csv" if use_detected else "../../Dataset/20250515 CSV_Data/Segmentation/Original/train.csv"
val_file = "../../Dataset/20250515 CSV_Data/Segmentation/Detected_padded/val.csv" if use_detected else "../../Dataset/20250515 CSV_Data/Segmentation/Original/val.csv"
test_file = "../../Dataset/20250515 CSV_Data/Segmentation/Detected_padded/test.csv" if use_detected else "../../Dataset/20250515 CSV_Data/Segmentation/Original/test.csv"
